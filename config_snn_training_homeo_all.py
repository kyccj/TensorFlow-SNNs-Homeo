...
# os.environ["CUDA_VISIBLE_DEVICES"]='2,3,4,6,7,8,5,9'#imagenet
...
conf.root_model_save = f'/mnt/hdd1/kyccj/H-all_layer/prototype/correlation'
# conf.root_model_save = f'./model_ckpt_test'
# conf.name_model_load= '/mnt/hdd1/kyccj/H-all_layer/prototype/correlation/VGG16_AP_CIFAR10/ep-310_bat-100_opt-ADAMW_lr-COS-5E-03_wd-3E-02_sc_ra_cm_re_ts-4_nc-R-R_nr-s'
conf.name_model_load = '/mnt/hdd1/kyccj/H-all_layer/prototype/correlation/ResNet19_CIFAR10/ep-310_bat-100_opt-ADAMW_lr-COS-5E-03_wd-3E-02_sc_ra_cm_re_ts-4_nc-R-R_nr-s/'
...
# conf.cal_correlation = True
conf.cal_correlation_weight = 10
